...
| `runbook.md` | **Current CSE pilot operator entry point.** One repeatable Blueback/Raider/Wheat/Fran checklist: branches → tools → profile → static catalog → pilot workspace → concretize → build. |
