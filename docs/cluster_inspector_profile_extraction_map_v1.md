...
| MPI compiler pairing | `mpi_providers[*].compiler`, `compatibility.compilers`, or `flavors` | Discovery admits only exact pairings. Error if a hand-written or malformed provider bypasses that boundary without one. |
