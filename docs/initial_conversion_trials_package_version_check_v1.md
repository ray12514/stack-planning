...
| Python | `3.14.5`, `3.13.13`; newest 3.12 is `3.12.13`; newest 3.10 is `3.10.20`; the only and newest 3.8 is `3.8.20` | The Initial Conversion Trials use `3.12.13`, `3.10.20`, and `3.8.20`, following the PET recommendations instead of the general newest-two rule. The recipe keeps `3.8.20` installable but marks it deprecated because Python 3.8 is EOL. | [active Python versions](https://github.com/spack/spack-packages/blob/v2026.06.0/repos/spack_repo/builtin/packages/python/package.py#L57-L63); [Python 3.8.20 status](https://github.com/spack/spack-packages/blob/v2026.06.0/repos/spack_repo/builtin/packages/python/package.py#L152-L159) |
