...
| `concretizer:reuse: true` | [concretizer template](../../stack-content/pilots/cse-pilot/templates/configs/common/concretizer.yaml.j2) | Reuses installed or already-concretized dependencies only when the complete dependency spec and hash match. |
